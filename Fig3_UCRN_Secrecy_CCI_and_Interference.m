...
grid,legend('L_R,\sigma^2_{pr},L_D,\sigma^2_{ir}= 1'...
,'L_R,\sigma^2_{pr}=2, L_D,\sigma^2_{ir}= 1'...
,'L_R,\sigma^2_{pr}=1, L_D,\sigma^2_{ir}= 2'...
,'L_R,\sigma^2_{pr},L_D,\sigma^2_{ir}= 2'...
,'L_R,\sigma^2_{pr},L_D,\sigma^2_{ir}= 2'...
,'Analytical')
...
xlabel('The average SINR of the main link (dB)'),ylabel('SOP')
